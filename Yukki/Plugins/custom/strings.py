...
**انت تستطيع استخدام [{BOT_NAME}](https://t.me/{BOT_USERNAME}) في تشغيل الاغاني او الفيديو في المكالمات الصوتيه للمجموعات.**

💡 **يمكنك التحدث مع المطور في حالة مواجهتك اي مشكله ➤ 📚 @libcubehawk**
"""
...
START_BUTTON_GROUP = InlineKeyboardMarkup(
    [   
        ...
        [
            InlineKeyboardButton(
                text="📣 Updates Channel", url="https://t.me/Updatescafu"
            ),
            InlineKeyboardButton(
                text="💬 Support Group", url="https://t.me/supp456"
            ),                       
        ],        
    ]
)
